...
pub const qoi_desc = extern struct {
    width: c_uint,
    height: c_uint,
    channels: u8,
    colorspace: u8,
...
pub extern fn qoi_read(filename: [*c]const u8, desc: [*c]qoi_desc, channels: c_int) ?*anyopaque;
...
pub const QOI_H = "";
pub const QOI_SRGB = @as(c_int, 0);
pub const QOI_LINEAR = @as(c_int, 1);
